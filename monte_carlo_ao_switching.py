...
def monte_carlo_ao_switching(n_lattice,  # size of the grid
    ...
    # Evaluate the averages and errors        
...
def free_energy_anharm(n_beta,
    ...
    v_ham, v_ham2 = monte_carlo_virial_theorem(400, 
                                               n_equil, 
                                               n_mc_sweeps,
                                               i_cold)

    virial_hamiltonian_av, virial_hamiltonian_err = \
        mc.stat_av_var(v_ham, v_ham2, 400 * (n_mc_sweeps - n_equil))
...
def monte_carlo_virial_theorem(n_lattice,  # size of the grid
    ...
    print(virial_hamiltonian)
    print(virial_hamiltonian2)
    return virial_hamiltonian, virial_hamiltonian2
...
def free_energy_anharm(n_beta,
    ...
    v_ham, v_ham2 = monte_carlo_virial_theorem(200, 
                                               n_equil, 
                                               n_mc_sweeps,
                                               i_cold)

    virial_hamiltonian_av, virial_hamiltonian_err = \
        mc.stat_av_var(v_ham, v_ham2, 200 * (n_mc_sweeps - n_equil))
...
if __name__ == '__main__':
    cP.run("free_energy_anharm(2, 100, 50000, 20, False)")
